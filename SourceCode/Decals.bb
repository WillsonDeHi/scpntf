...
Const DECAL_TYPE_BLOODSPLAT% = 2
Const DECAL_TYPE_BLOODDROP% = 3
;[End Block]
...
Function LoadDecals(isMultiplayer% = False)
	...
	If (Not isMultiplayer) Then
		...
		Next
		DecalTextures[DECAL_PAPERSTRIPS] = LoadTexture_Strict("GFX\items\INVpaperstrips.jpg", 1+2, 2)
	...
	Next
	DecalTextures[DECAL_SLASHHOLE] = LoadTexture_Strict("GFX\slashhole1.jpg", 1+2, 2)
